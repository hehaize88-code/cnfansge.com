...
export function ArticlePage({ slug, initialLang = "en" }: { slug: ArticleSlug; initialLang?: Lang }) {
  ...
  const articleDate = slug === "kakobuy-apartment-suite-unit-zip4-checks" ? "2026-09-10" : slug === "kakobuy-us-delivery-address-format" ? "2026-09-04" : slug === "kakobuy-usa-pre-order-readiness-checklist" ? "2026-09-02" : "2026-08-31";
