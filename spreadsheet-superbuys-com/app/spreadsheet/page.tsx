      ...
      <main className="index-main">
        ...
        <section className="verification-snapshot wrap" aria-labelledby="verification-snapshot-title">
          <div className="verification-summary">
            ...
            <p data-i18n="linkSnapshotIntro">Checked 14 September 2026. A successful response confirms that the destination opens; it does not guarantee stock, current price, seller identity or variant accuracy.</p>
          </div>
          <div className="verification-grid">
            {products.map((product, index) => (
              <a href={product.href} target="_blank" rel="noopener noreferrer" className="verification-item" key={product.id}>
                ...
                <span><b data-i18n={`productTitle${index + 1}`}>{product.title}</b><small><span data-i18n="destinationReachable">Destination reachable</span> · <span data-i18n="checkedDateShort">Checked 14 Sep 2026</span></small></span>
              </a>
            ))}
          </div>
        </section>
