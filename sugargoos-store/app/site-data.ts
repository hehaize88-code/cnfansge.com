...
export const copy: Record<Language, Copy> = {
  en: {
    ...
    heroTitle: "Find first. Check twice. Ship smarter.",
    ...
    pageTitles: {
      spreadsheet: "Sugargoo Spreadsheet 2026 — Search Curated Product Routes",
      ...
      shipping: "Sugargoo Shipping Guide — Weight, Volume & Parcel Planning",
