...
export const copy: Record<Locale, Copy> = {
  en: {
    ...
    articlesIntro: "Long-form methods for preserving references, interpreting QC photos and turning visible evidence into a defensible decision.",
    read: "Read guide",
    ...
    sectionTitles: { spreadsheet: "Use an OOPBUY spreadsheet to preserve the QC evidence trail", finds: "Shortlist products by the QC evidence they will require", guide: "Build an OOPBUY visual-evidence trail from listing to warehouse", qc: "Read OOPBUY QC photos as visual evidence", shipping: "Turn warehouse evidence into safer packing decisions", faq: "Frequently asked questions", articles: "OOPBUY QC photo analysis and visual-evidence guides" },
    sectionIntros: { spreadsheet: "Search and filter the existing routes, then preserve the option, identifier and visual reference needed for a later warehouse comparison.", finds: "A focused selection across shoes, clothing, jerseys and accessories, organized around the evidence each item will require after stock-in.", guide: "A traceable sequence that keeps listing, order, warehouse image and parcel records connected without treating one source as proof of everything.", qc: "A category-aware method for separating visible observation, reasonable uncertainty and claims an ordinary warehouse photo cannot support.", shipping: "Use visible condition and product structure to identify packing priorities while keeping rate and route calculations outside this site’s primary search intent.", faq: "The important process questions, answered directly and with official-policy dates called out.", articles: "Detailed OOPBUY QC photo methods that build visual literacy without repeating broad spreadsheet, fee or route topics." },
  },
  de: {
    ...
    sectionTitles: { spreadsheet: "Mit einer OOPBUY-Tabelle die QC-Belegspur sichern", finds: "Produkte nach den benötigten QC-Belegen auswählen", guide: "Eine OOPBUY-Belegspur vom Angebot bis zum Lager führen", qc: "OOPBUY-QC-Fotos als sichtbare Belege lesen", shipping: "Lagerbelege in sichere Verpackungsentscheidungen übersetzen", faq: "Häufig gestellte Fragen", articles: "OOPBUY-QC-Fotoanalyse und Guides zu visuellen Belegen" },
    sectionIntros: { spreadsheet: "Vorhandene Routen suchen und filtern, danach Variante, ID und sichtbare Referenz für den späteren Lagervergleich sichern.", finds: "Eine fokussierte Auswahl aus Schuhen, Kleidung, Trikots und Accessoires, geordnet nach den nach Einlagerung benötigten Belegen.", guide: "Ein nachvollziehbarer Ablauf, der Angebot, Bestellung, Lagerbild und Paketdatensatz verbindet, ohne eine Quelle als Beweis für alles zu behandeln.", qc: "Eine kategoriespezifische Methode, die sichtbare Beobachtung, vernünftige Unsicherheit und nicht belegbare Bildaussagen trennt.", shipping: "Sichtbaren Zustand und Produktstruktur für Verpackungsprioritäten nutzen; Preis- und Routenberechnung bleiben außerhalb der primären Suchabsicht.", faq: "Die wichtigsten Prozessfragen direkt beantwortet, mit Datum der offiziellen Regeln.", articles: "Detaillierte Methoden für OOPBUY-QC-Fotos, ohne breite Tabellen-, Gebühren- oder Routenthemen zu wiederholen." },
  },
  es: {
    ...
    sectionTitles: { spreadsheet: "Usa una hoja OOPBUY para conservar el rastro QC", finds: "Selecciona productos por la evidencia QC que exigirán", guide: "Crea un rastro visual OOPBUY del anuncio al almacén", qc: "Lee las fotos QC de OOPBUY como evidencia visual", shipping: "Convierte la evidencia del almacén en mejor embalaje", faq: "Preguntas frecuentes", articles: "Análisis de fotos QC de OOPBUY y guías de evidencia visual" },
    sectionIntros: { spreadsheet: "Busca y filtra las rutas existentes; después conserva opción, ID y referencia visual para la comparación del almacén.", finds: "Una selección concreta de calzado, ropa, camisetas y accesorios organizada por la evidencia necesaria después de la entrada.", guide: "Una secuencia trazable que une anuncio, pedido, imagen de almacén y paquete sin convertir una fuente en prueba de todo.", qc: "Un método por categorías que separa observación visible, incertidumbre razonable y afirmaciones que una foto normal no respalda.", shipping: "Usa estado y estructura visibles para priorizar embalaje; tarifas y rutas quedan fuera de la intención principal de este sitio.", faq: "Las preguntas clave del proceso, con fechas de las políticas oficiales.", articles: "Métodos detallados de fotos QC sin repetir temas generales de hojas, tarifas o rutas." },
  },
  fr: {
    ...
    sectionTitles: { spreadsheet: "Utiliser un tableau OOPBUY pour préserver la trace QC", finds: "Sélectionner selon les preuves QC nécessaires", guide: "Construire une trace visuelle OOPBUY de l’annonce à l’entrepôt", qc: "Lire les photos QC OOPBUY comme preuves visuelles", shipping: "Transformer les preuves d’entrepôt en choix d’emballage", faq: "Questions fréquentes", articles: "Analyse des photos QC OOPBUY et guides de preuve visuelle" },
    sectionIntros: { spreadsheet: "Recherchez les routes existantes puis conservez option, identifiant et référence visuelle pour le futur contrôle d’entrepôt.", finds: "Une sélection ciblée de chaussures, vêtements, maillots et accessoires organisée selon les preuves nécessaires après entrée.", guide: "Une séquence traçable reliant annonce, commande, image d’entrepôt et colis sans faire d’une source une preuve totale.", qc: "Une méthode par catégorie séparant observation visible, incertitude raisonnable et affirmations qu’une photo ordinaire ne soutient pas.", shipping: "Utilisez état et structure visibles pour prioriser l’emballage ; tarifs et routes restent hors de l’intention principale.", faq: "Les questions clés, avec la date des règles officielles.", articles: "Des méthodes détaillées sur les photos QC sans répéter tableurs, frais ou routes généralistes." },
  },
  it: {
    ...
    sectionTitles: { spreadsheet: "Usa un foglio OOPBUY per conservare la traccia QC", finds: "Seleziona i prodotti in base alle prove QC necessarie", guide: "Crea una traccia visiva OOPBUY dall’annuncio al magazzino", qc: "Leggi le foto QC OOPBUY come prove visive", shipping: "Trasforma le prove del magazzino in scelte d’imballaggio", faq: "Domande frequenti", articles: "Analisi delle foto QC OOPBUY e guide alle prove visive" },
    sectionIntros: { spreadsheet: "Cerca e filtra i percorsi esistenti, poi conserva opzione, ID e riferimento visivo per il confronto in magazzino.", finds: "Una selezione mirata di scarpe, abbigliamento, maglie e accessori organizzata secondo le prove necessarie dopo l’ingresso.", guide: "Una sequenza tracciabile che collega annuncio, ordine, immagine di magazzino e pacco senza trattare una fonte come prova totale.", qc: "Un metodo per categoria che separa osservazione visibile, incertezza ragionevole e affermazioni non sostenibili da una foto ordinaria.", shipping: "Usa stato e struttura visibili per le priorità d’imballaggio; tariffe e rotte restano fuori dall’intento principale.", faq: "Le domande principali con le date delle regole ufficiali.", articles: "Metodi dettagliati sulle foto QC senza ripetere fogli, tariffe o rotte generali." },
  },
};

export type Product = { id: string; name: string; category: string; price: string; image: string; href: string; note: string };
export const products: Product[] = [
  { id: "6681", name: "Heavyweight graphic sweatshirt", category: "Hoodies", price: "$25.15", image: "/products/6681.webp", href: `${DESTINATION}/AllProducts/6681.html`, note: "Product ID 7755101935" },
  { id: "6680", name: "Relaxed pants / shorts", category: "Pants", price: "$28.13", image: "/products/6680.webp", href: `${DESTINATION}/AllProducts/6680.html`, note: "Product ID 7755051257" },
  { id: "6679", name: "Football jersey selection", category: "Jerseys", price: "$19.49", image: "/products/6679.webp", href: `${DESTINATION}/AllProducts/6679.html`, note: "Product ID 7641464690" },
  { id: "5760", name: "Air-cushion runner", category: "Shoes", price: "$22.32", image: "/products/5760.webp", href: `${DESTINATION}/AllProducts/5760.html`, note: "Product ID 7675283980" },
  { id: "2450", name: "Web motif hoodie", category: "Hoodies", price: "$27.53", image: "/products/2450.webp", href: `${DESTINATION}/AllProducts/2450.html`, note: "Product ID 7611589527" },
  { id: "934", name: "Gel-cushion trainer", category: "Shoes", price: "$36.46", image: "/products/934.webp", href: `${DESTINATION}/AllProducts/934.html`, note: "Product ID 7586091890" },
  { id: "5895", name: "Graphic T-shirt collection", category: "T-Shirts", price: "$13.24", image: "/products/5895.webp", href: `${DESTINATION}/AllProducts/5895.html`, note: "40-style listing · ID 7672917747" },
  { id: "5841", name: "Coated canvas mini bag", category: "Accessories", price: "$14.29", image: "/products/5841.webp", href: `${DESTINATION}/AllProducts/5841.html`, note: "Product ID 7675824966" },
];
...
const articleMeta: Record<Locale, { slug: string; title: string; deck: string; readTime: string }[]> = {
  en: [
    { slug: "oopbuy-spreadsheet-workflow", title: "Use an OOPBUY spreadsheet as a QC evidence trail", deck: "Preserve the exact option and visual reference from first click to warehouse review.", readTime: "10 min read" },
    { slug: "oopbuy-qc-photo-checklist", title: "OOPBUY QC photo analysis: a category-by-category visual framework", deck: "What warehouse images can prove, what they cannot, and how to mark the evidence gap.", readTime: "9 min read" },
    { slug: "oopbuy-shipping-cost-planner", title: "OOPBUY packing evidence: use warehouse photos before parcel decisions", deck: "Translate visible condition and structure into specific protection priorities before shipping.", readTime: "9 min read" },
  ],
  de: [
    { slug: "oopbuy-spreadsheet-workflow", title: "Eine OOPBUY-Tabelle als QC-Belegspur nutzen", deck: "Genaue Option und Bildreferenz vom ersten Klick bis zur Lagerprüfung sichern.", readTime: "10 Min." },
    { slug: "oopbuy-qc-photo-checklist", title: "OOPBUY-QC-Fotoanalyse: visueller Rahmen nach Kategorie", deck: "Was Lagerbilder belegen, was nicht und wie Beleglücken markiert werden.", readTime: "9 Min." },
    { slug: "oopbuy-shipping-cost-planner", title: "OOPBUY-Verpackungsbelege: Lagerfotos vor Paketentscheidungen nutzen", deck: "Sichtbaren Zustand und Struktur in konkrete Schutzprioritäten übersetzen.", readTime: "9 Min." },
  ],
  es: [
    { slug: "oopbuy-spreadsheet-workflow", title: "Usa una hoja OOPBUY como rastro de evidencia QC", deck: "Conserva opción y referencia visual desde el primer clic hasta el almacén.", readTime: "10 min" },
    { slug: "oopbuy-qc-photo-checklist", title: "Análisis de fotos QC OOPBUY: marco visual por categorías", deck: "Qué demuestran las imágenes, qué no y cómo marcar la evidencia ausente.", readTime: "9 min" },
    { slug: "oopbuy-shipping-cost-planner", title: "Evidencia de embalaje OOPBUY: usa las fotos antes del paquete", deck: "Convierte estado y estructura visibles en prioridades concretas de protección.", readTime: "9 min" },
  ],
  fr: [
    { slug: "oopbuy-spreadsheet-workflow", title: "Utiliser un tableau OOPBUY comme trace de preuve QC", deck: "Conserver option et référence visuelle du premier clic au contrôle d’entrepôt.", readTime: "10 min" },
    { slug: "oopbuy-qc-photo-checklist", title: "Analyse des photos QC OOPBUY : cadre visuel par catégorie", deck: "Ce que les images prouvent, leurs limites et la preuve qui manque.", readTime: "9 min" },
    { slug: "oopbuy-shipping-cost-planner", title: "Preuve d’emballage OOPBUY : utiliser les photos avant le colis", deck: "Traduire état et structure visibles en priorités de protection concrètes.", readTime: "9 min" },
  ],
  it: [
    { slug: "oopbuy-spreadsheet-workflow", title: "Usa un foglio OOPBUY come traccia di evidenza QC", deck: "Conserva opzione e riferimento visivo dal primo clic al controllo in magazzino.", readTime: "10 min" },
    { slug: "oopbuy-qc-photo-checklist", title: "Analisi delle foto QC OOPBUY: quadro visivo per categoria", deck: "Cosa provano le immagini, i loro limiti e quale evidenza manca.", readTime: "9 min" },
    { slug: "oopbuy-shipping-cost-planner", title: "Prove d’imballaggio OOPBUY: usa le foto prima del pacco", deck: "Trasforma stato e struttura visibili in priorità concrete di protezione.", readTime: "9 min" },
  ],
};
...
export function getArticles(locale: Locale): Article[] {
  ...
  return articles.map((article) => {
    ...
    const sections = article.sections.map((section, index) => index === article.sections.length - 1
      ? { ...section, paragraphs: [...section.paragraphs, ...additions] }
      : section);
