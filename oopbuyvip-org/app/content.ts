...
type Copy = {
  ...
  hero: { kicker: string; title: string; body: string; proof: string; search: string; searchButton: string; browse: string };
...
sharedArticles.en = englishArticles;
sharedArticles.de = germanArticles;
sharedArticles.es = spanishArticles;
sharedArticles.fr = frenchArticles;
sharedArticles.it = italianArticles;
...
const localizedFaqExtras: Record<Exclude<Language, "en">, Copy["faq"]> = {
  de: [
    { q: "Welche Einkaufsagent-Gebühr veröffentlicht OOPBuy?", a: "Die am 1. September 2026 geprüfte Nutzungsvereinbarung nennt 8 % des ausgewählten Warenkaufpreises. Der aktuelle Checkout und die jeweils gültige Vereinbarung bleiben maßgeblich." },
  ...
  es: [
    { q: "¿Qué comisión de compra asistida publica OOPBuy?", a: "El acuerdo de usuario revisado el 1 de septiembre de 2026 indica un 8 % del precio de compra seleccionado. El checkout y el acuerdo vigentes son siempre la referencia final." },
  ...
  fr: [
    { q: "Quels frais d'achat assisté OOPBuy publie-t-il ?", a: "L'accord utilisateur examiné le 1er septembre 2026 indique 8 % du prix d'achat sélectionné. Le checkout et l'accord en vigueur restent la source finale." },
  ...
  it: [
    { q: "Quale commissione di acquisto assistito pubblica OOPBuy?", a: "L'accordo utente verificato il 1 settembre 2026 indica l'8% del prezzo di acquisto selezionato. Checkout e accordo vigenti restano la fonte finale." },
...
const localizedPointExtras: Record<Exclude<Language, "en">, Record<string, { title: string; body: string }[]>> = {
  ...
  fr: {
    spreadsheet: [{ title: "Coût total, pas seulement la fiche", body: "Séparez livraison locale, référence de 8 %, paiement, entrepôt et fret international." }, { title: "Statut QC documenté", body: "Retour, preuve absente ou prêt pour le colis évite un regroupement non contrôlé." }, { title: "Entretien avant volume", body: "Dates, liens actifs et doublons retirés valent mieux que des milliers de lignes abandonnées." }],
...
for (const lang of ["de", "es", "fr", "it"] as const) {
  ...
  copy[lang] = makeCopy(lang, {
    ...
    hero: { kicker: x.hero[0], title: x.hero[1], body: x.hero[2], proof: x.hero[3], search: x.hero[4], searchButton: x.hero[5], browse: x.hero[6] },
