...
type ArticlePageKey=Extract<PageKey,"qcArticle"|"shippingArticle"|"storageArticle"|"orderIdentifiersArticle"|"orderTimelineArticle">;
const articleKeys:ArticlePageKey[]=["shippingArticle","storageArticle","qcArticle","orderIdentifiersArticle","orderTimelineArticle"];
function getArticle(locale:Locale,page:ArticlePageKey){return page==="orderIdentifiersArticle"?orderIdentifiersArticleData[locale]:page==="orderTimelineArticle"?orderTimelineArticleData[locale]:articleData[locale][page];}
...
function ArticlePage({locale,page}:{locale:Locale;page:ArticlePageKey}) {
  ...
  const articleDate=page==="orderTimelineArticle"?"2026-09-02":"2026-08-31";
  ...
  const faqs=page==="orderIdentifiersArticle"?orderIdentifiersArticleData[locale].faqs:page==="orderTimelineArticle"?orderTimelineArticleData[locale].faqs:null;
