...
type ArticlePageKey=Extract<PageKey,"qcArticle"|"shippingArticle"|"storageArticle"|"orderIdentifiersArticle"|"orderTimelineArticle"|"sellerHandoffArticle"|"domesticReceiptArticle"|"warehouseIntakeArticle">;
const articleKeys:ArticlePageKey[]=["shippingArticle","storageArticle","qcArticle","orderIdentifiersArticle","orderTimelineArticle","sellerHandoffArticle","domesticReceiptArticle","warehouseIntakeArticle"];
function getArticle(locale:Locale,page:ArticlePageKey){return page==="orderIdentifiersArticle"?orderIdentifiersArticleData[locale]:page==="orderTimelineArticle"?orderTimelineArticleData[locale]:page==="sellerHandoffArticle"?sellerHandoffArticleData[locale]:page==="domesticReceiptArticle"?domesticReceiptArticleData[locale]:page==="warehouseIntakeArticle"?warehouseIntakeArticleData[locale]:articleData[locale][page];}
...
function ArticlePage({locale,page}:{locale:Locale;page:ArticlePageKey}) {
  ...
  const articleDate=page==="warehouseIntakeArticle"?"2026-09-12":page==="domesticReceiptArticle"?"2026-09-10":page==="sellerHandoffArticle"?"2026-09-04":page==="orderTimelineArticle"?"2026-09-02":"2026-08-31";
  ...
  const faqs=page==="orderIdentifiersArticle"?orderIdentifiersArticleData[locale].faqs:page==="orderTimelineArticle"?orderTimelineArticleData[locale].faqs:page==="sellerHandoffArticle"?sellerHandoffArticleData[locale].faqs:page==="domesticReceiptArticle"?domesticReceiptArticleData[locale].faqs:page==="warehouseIntakeArticle"?warehouseIntakeArticleData[locale].faqs:null;
