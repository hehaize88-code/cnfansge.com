...
export default function sitemap():MetadataRoute.Sitemap {
  return localeCodes.flatMap(locale=>(Object.keys(pagePaths) as PageKey[]).map(page=>({
    ...
    lastModified:new Date(page==="warehouseIntakeArticle"?"2026-09-12":page==="domesticReceiptArticle"?"2026-09-10":page==="sellerHandoffArticle"?"2026-09-04":page==="orderTimelineArticle"?"2026-09-02":"2026-08-31"),
