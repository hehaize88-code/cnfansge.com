...
export const articles: Article[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Before purchasing, ask whether the item still makes sense after shipping. Use the current estimate or in-account quote available for your destination, but remember that any estimate depends on the information entered. Weight alone is not enough for bulky goods. Carriers may compare actual weight with dimensional or volumetric weight, which represents the space a parcel occupies. Shoes with boxes, thick jackets, bags that cannot be compressed and rigid packaging can change the chargeable weight substantially.",
    ...
    sources: [
      { label: "Hipobuy official website", note: "Current platform positioning and official service entry points." },
  ...
  },
  {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Hipobuy’s official app listings advertise global delivery to more than 200 countries. Any estimator or pre-purchase range is a planning tool, not a final quote. The output depends on destination, item category, estimated weight, dimensions, route rules and current pricing. The final packed parcel and routes shown in the account provide better information than a product thumbnail."
        ]
      },
      {
      ...
      {
        heading: "Use a shipping estimate correctly",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "As of 25 August 2026, Google Play displayed a 3.4 rating from 865 reviews, while the United States Apple App Store displayed 3.2 from 261 ratings. Store ratings are regional and can change. The written reviews include praise for organization and workflow, alongside complaints about shipping cost, communication, delays and app performance. A responsible guide should report that mix rather than selecting only the most dramatic comments.",
          "Use reviews to identify questions to investigate: Was dimensional weight understood? Was the route insured? Did the buyer compare lines? Was a delay in customs, the last-mile carrier or warehouse processing? Did an app-performance complaint relate to a particular device or version? A review describes one order and may omit important context. It is useful evidence of possible outcomes, not a universal price or delivery forecast."
        ]
      },
      {
        heading: "Country-specific costs need country-specific checks",
        paragraphs: [
          "Hipobuy’s official app description says the service ships to more than 200 countries. Those destinations do not share one tax system, customs threshold, delivery network or set of routes. A useful country guide should direct readers to current official government information and explain the platform workflow without pretending to provide legal advice.",
    ...
    sources: [
      ...
      { label: "Hipobuy Google Play listing", note: "Current app description, rating and review themes checked on 25 August 2026." },
      { label: "Hipobuy United States App Store listing", note: "Current rating and review themes checked on 25 August 2026." }
    ]
  }
];
